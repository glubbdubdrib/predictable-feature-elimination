...
plt.tight_layout()
plt.savefig(f'{results_dir}legend_classification.png', bbox_inches=matplotlib.transforms.Bbox([[0.4, 2.4], [4, 3.3]]))
plt.savefig(f'{results_dir}legend_classification.pdf', bbox_inches=matplotlib.transforms.Bbox([[0.4, 2.4], [4, 3.3]]))
plt.show()
